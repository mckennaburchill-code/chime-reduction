#Python function that filters the data and allows for a calculation of each day of solar flux values:
...
#days in the year of 2025 that do not exist(the files do not exist from Learmonth)
...
#Data sorting, filtering out days that exist from the year 2025: 
...
#lists for specific days that don't have files in the year 2025
...
full_list_sort.to_csv("filtering_flux_dat.csv", index=False)